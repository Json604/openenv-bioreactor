...
Batch_run_flags.Raman_spec =0*ones(1,Num_of_Batches);  % 0 - Don't Record Raman data 
      ...
      % 5 batches: 3 normal + 1 substrate fault + 1 aeration fault
      % Fault codes: 0=None, 1=Aeration, 2=Pressure, 3=Substrate,                                                                                                                                     
      %              4=Base, 5=Coolant, 6=All, 7=Temp sensor, 8=pH sensor                                                                                                                             
      Batch_run_flags.Batch_fault_order_reference = [0 0 0 3 1];                                                                                                                                      
                                                                                                                                                                                                      
      % All recipe-driven (SBC), all fixed length (easier to compare),                                                                                                                                
      % no Raman.                                                                                                                                                                                     
      Batch_run_flags.Control_strategy = [0 0 0 0 0];                                                                                                                                                 
      Batch_run_flags.Batch_length     = [0 0 0 0 0];
      Batch_run_flags.Raman_spec       = [0 0 0 0 0];                                                                                                                                                 
